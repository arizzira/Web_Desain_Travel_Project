  ...
  return (
    <>
      ...
      >
        <div
          id="home"
          className="flex justify-between flex-row-reverse items-center pt-[42px] pb-[42px] pl-[24px] pr-[24x] max-md:!flex-col"
        >
          ...
          <div className="flex flex-col gap-7">
            ...
            <h1 className="text-6xl font-semibold">Travel Bersama Kami</h1>
            <p className="text-sm">
